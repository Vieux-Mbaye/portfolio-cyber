    ...
    <section ref={ref} className="py-20 px-6 bg-slate-950 cyber-grid">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-blue-200 max-w-4xl mx-auto mb-8 text-justify">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-2 cyber-border rounded-lg p-8 bg-slate-900/50"
          >
            <h3 className="text-2xl font-bold text-blue-400 mb-6">Compétences Techniques Avancées</h3>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">Cryptographie & Cryptanalyse</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">Pentesting & Audit de Sécurité</h4>
                <div className="space-y-1 text-sm text-blue-200">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">Gestion des Vulnérabilités</h4>
                <div className="space-y-1 text-sm text-blue-200">
            ...
            <div className="mt-6 grid md:grid-cols-3 gap-6">
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">Sécurité des Protocoles & Web</h4>
                <div className="space-y-1 text-sm text-blue-200">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">SOC & Réponse aux Incidents</h4>
                <div className="space-y-1 text-sm text-blue-200">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">Gestion des Identités & Ingénierie Sociale</h4>
                <div className="space-y-1 text-sm text-blue-200">
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-3">DevSecOps & Gestion de Projet SSI</h4>
                <div className="space-y-1 text-sm text-blue-200">
          ...
          >
            {/* Certifications */}
            <div className="cyber-border rounded-lg p-6 bg-slate-900/50">
              <h3 className="text-xl font-bold text-blue-400 mb-4">Certifications & Formation</h3>
              <div className="space-y-3">
                {certifications.map((cert, index) => (
                  ...
                  >
                    ...
                    <span className="text-blue-200 text-sm">{cert}</span>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="cyber-border rounded-lg p-6 bg-slate-900/50">
              <h3 className="text-xl font-bold text-blue-400 mb-4">Conformité & Réglementations</h3>
              <div className="space-y-3">
                {compliance.map((comp, index) => (
                  ...
                  >
                    ...
                    <span className="text-green-200 text-sm">{comp}</span>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="cyber-border rounded-lg p-6 bg-slate-900/50">
              <h3 className="text-xl font-bold text-blue-400 mb-4">Langues & Qualités</h3>
              <div className="space-y-3">
                <div className="text-blue-200">
                  <div className="font-medium">Langues</div>
                  <div className="text-sm text-slate-300">Français (natif) • Anglais (professionnel)</div>
                </div>
                <div className="text-blue-200">
                  <div className="font-medium">Qualités</div>
                  <div className="text-sm text-slate-300">Persévérance • Leadership • Esprit d'équipe</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 cyber-border rounded-lg p-8 bg-slate-900/50"
        >
          <h3 className="text-2xl font-bold text-blue-400 mb-6">Contributions & Publications Techniques</h3>
          <div className="space-y-8">
            {/* First row with 2 articles */}
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="cyber-border rounded-lg p-6 bg-slate-800/50">
                <h4 className="text-xl font-semibold text-white mb-3">
                  Article technique : "Exploitation de la vulnérabilité CVE-2021-3156 — Baron Samedit"
                </h4>
                <p className="text-blue-200 text-sm mb-3">Publié sur LinkedIn & Medium</p>
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm rounded transition-colors"
                >
              ...
              <div className="cyber-border rounded-lg p-6 bg-slate-800/50">
                <h4 className="text-xl font-semibold text-white mb-3">
                  Article technique : "De la vulnérabilité au shell : comprendre et construire une attaque ROP de A à Z"
                </h4>
                <p className="text-blue-200 text-sm mb-3">Publié sur Medium & LinkedIn</p>
                <div className="space-y-2 text-sm text-blue-100 mb-4">
                  <div>
            ...
            <div className="flex justify-center">
              <div className="cyber-border rounded-lg p-6 bg-slate-800/50 max-w-lg">
                <h4 className="text-xl font-semibold text-white mb-3">
                  Article technique : "Du ROP à l'aveugle : la magie du BROP"
                </h4>
                <p className="text-blue-200 text-sm mb-3">Publié sur Medium & LinkedIn</p>
                <div className="space-y-2 text-sm text-blue-100 mb-4">
                  <div>
                ...
                <a
                  href="https://medium.com/@vieuxmbayendour/du-rop-%C3%A0-laveugle-la-magie-du-brop-b8c5c9e8a8a8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm rounded transition-colors"
                >
